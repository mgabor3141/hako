...
- [0001](0001-three-repos.md) — Two repos: hako (with the adapters) and a gateway fork
...
- [0007](0007-mcp-gateway.md) — The gateway is a remote-proxy container sidecar
...
- [0013](0013-mcpeel-delivery.md) — The MCP CLI adapters are inlined into hako
